export const JP = {
   ...
   AccountTradeTileReservationTimeDesc: "This is the time your player trade tile will be reserved for you since you are last online. After the reservation period has ended, your tile will become available for other players",
   ...
   BrandenburgGateDesc: "All coal mines and oil wells get +1 Production, Storage and Worker Capacity Multiplier. Oil refineries get +1 Production, Storage and Worker Capacity Multiplier for each adjacent oil tile",
   Bread: "Bread",
   Brewery: "Brewery",
   Brick: "Brick",
   ...
   BuildingColorMatchBuildingTooltip: "Copy resource color from the building that produce this resource. If multiple buildings produce this resource, a random one will be selected",
   ...
   ChichenItzaDesc: "All adjacent buildings get +1 Production Multiplier, Storage and Worker Capacity Multiplier",
   Chinese: "Chinese",
   ...
   EiffelTowerDesc: "All adjacent steel mills get +N Production, Storage and Worker Multiplier. N = Number of adjacent steel mills",
   ...
   ForbiddenCityDesc: "All Paper Makers, Writer's Guilds and Printing Houses get +1 Production Multiplier, Worker Capacity Multiplier and Storage Multiplier",
   Forex: "Forex",
   ...
   HangingGardenDesc: "+1 Builder Capacity Multiplier. Adjacent aqueducts get +1 Production, Storage and Worker Capacity Multiplier",
   Happiness: "Happiness",
   ...
   HatshepsutTempleDesc: "Reveal all water tiles on the map when completed. Wheat Farms get +1 Production Multiplier for each adjacent water tile",
   ...
   HimejiCastleDesc: "All Caravel Builders, Galleon Builders, and Frigate Builders get +1 Production Multiplier, Worker Capacity Multiplier and Storage Multiplier",
   Hollywood: "Hollywood",
   ...
   PersepolisDesc: "All Copper Mining Camps, Logging Camps and Stone Quarries get +1 Production Multiplier, Worker Capacity Multiplier and Storage Multiplier",
   ...
   PlayerMapTariffDesc: "Every trade that goes through your tile will pay tariff to you. It's a balance: if you increase the tariff, the more you will gain from each trade, but fewer trade will go through your tile.",
   ...
   RijksmuseumDesc: "+5 Happiness. All buildings that consume or produce Culture get +1 Production, Storage and Worker Capacity",
   ...
   StatueOfLibertyDesc: "All adjacent buildings get +N Production, Storage and Worker Capacity Multiplier. N = Number of its adjacent buildings of the same type",
   ...
   SummerPalaceDesc: "All adjacent buildings that consume or produce Gunpowder are exempt from -1 Happiness. All buildings that consume or produce Gunpowder get +1 Production, Storage and Worker Capacity",
   ...
   TempleOfArtemisDesc: "All Sword Forges and Armories get +5 Level when completed. All Sword Forges and Armories get +1 Production Multiplier, Worker Capacity Multiplier and Storage Multiplier",
   ...
   TerracottaArmyDesc: "All Iron Mining Camps get +1 Production Multiplier, Worker Capacity Multiplier and Storage Multiplier. Iron Forges get +1 Production Multiplier for each adjacent Iron Mining Camp",
   ...
   Winery: "Winery",
   Wonder: "Wonder",
   WonderBuilderCapacityDescHTML: "<b>Builder Capacity</b> when constructing wonders are affect by the <b>age</b> and <b>technology</b> that unlocks the wonder",
